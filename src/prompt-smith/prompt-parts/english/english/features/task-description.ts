export const taskDescription = `Return the non-inflectional (inherent/lexical) grammatical features for the given English word as short, lowercase tag path components.
