...
- `textfresser` should treat `src/packages/independent/lexical-generation/` as if it were an external package
...
- document and then tighten the intended public exports of `src/packages/independent/lexical-generation/index.ts`
...
- `src/packages/independent/lexical-generation/index.ts` exposes a small workspace-ready surface
