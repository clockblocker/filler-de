 ...
 *
 * NOTE: For new code, prefer `@textfresser/library-core/path-finder.ts`
 * to keep section-chain/path logic centralized.
 *
 * @see PathFinder.parseSectionChainToNodeNames in `@textfresser/library-core/path-finder.ts`
 */
