...
// README_BLOCK:ling-id-observed-walk:start
const walkLemma = {
	canonicalLemma: "walk",
	inherentFeatures: {},
	language: "English",
...
// README_BLOCK:ling-id-observed-walk:end

// README_BLOCK:ling-id-observed-see:start
...
// README_BLOCK:ling-id-observed-see:end
