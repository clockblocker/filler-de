...
Rules:
- Compare the contextual meaning against each sense's senseEmojis emojis and linguistic features (unitKind, pos, phrasemeKind)
...
<example-1>
<input>
{"context":"I went to the bank to withdraw money.","lemma":"bank","senses":[{"senseEmojis":["🏞️","🌊"],"index":1,"pos":"Noun","unitKind":"Lexem"}]}
</input>
<output>
...
<example-2>
<input>
{"context":"We sat on the bank of the river.","lemma":"bank","senses":[{"senseEmojis":["🏞️","🌊"],"index":1,"pos":"Noun","unitKind":"Lexem"},{"senseEmojis":["🏦"],"index":2,"pos":"Noun","unitKind":"Lexem"}]}
</input>
<output>
{"matchedIndex":1}
</output>
...
<example-3>
<input>
{"context":"To be honest, I did not expect that.","lemma":"to be honest","senses":[{"senseEmojis":["🗣️"],"index":1,"phrasemeKind":"DiscourseFormula","unitKind":"Phrasem"},{"senseEmojis":["🤝"],"index":2,"phrasemeKind":"Collocation","unitKind":"Phrasem"}]}
</input>
<output>
{"matchedIndex":1}
</output>
