...
**Files**: `get-folder-happy.test.ts`
...
**Files**: `get-folder-errors.test.ts`
...
**Files**: `create-file-basic.test.ts`
...
**Files**: `create-folder-basic.test.ts`
- ✅ Create new folder

**Effort**: Low - Already implemented

### TFileHelper.createMdFile() - Simple Idempotency
**Files**: `create-file-idempotent.test.ts`
...
**Files**: `create-file-nested.test.ts`
...
**Files**: `trash-file-happy.test.ts`
...
**Files**: `trash-file-idempotent.test.ts`
...
**Files**: `trash-file-errors.test.ts`
...
**Files**: `create-file-race.test.ts`
