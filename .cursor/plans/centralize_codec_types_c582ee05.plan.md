...
1. **Create `codecs/canonical-split-path/types/index.ts**`
...
2. **Update `codecs/canonical-split-path/types.ts**`
  - Remove re-exports
  - Re-export from `types/index.ts`
3. **Update imports across codebase**
...
1. **Create `codecs/locator/types/schemas.ts**`
...
2. **Create `codecs/locator/types/index.ts**`
...
3. **Update `codecs/locator/types.ts**`
  - Remove re-exports from healer
  - Re-export from `types/index.ts`
4. **Update `healer/library-tree/tree-action/types/target-chains.ts**`
  - Remove locator type definitions
    - Re-export from `codecs/locator/types/` (backward compatibility)

### Phase 4: Add Generic SegmentIdOf

1. **Update `codecs/types/type-mappings.ts**`
