...
// 			const result = prettyPathFromSystemPath('');
...
// 			const result = prettyPathFromSystemPath('/file.md');
// 			expect(result).toEqual({ basename: 'file.md', pathParts: [], type: 'folder' });
// 		});

// 		it('converts nested file path correctly', () => {
// 			const result = prettyPathFromSystemPath('/folder/subfolder/file.md');
...
// 			const result = prettyPathFromSystemPath('/folder/subfolder/');
// 			expect(result).toEqual({
// 				basename: 'subfolder',
// 				pathParts: ['folder'],
// 				type: 'folder',
...
// 			const result = prettyPathFromSystemPath('folder/file.md');
// 			expect(result).toEqual({
// 				basename: 'file.md',
// 				pathParts: ['folder'],
// 				type: 'folder',
...
// 			const result = prettyPathFromSystemPath('folder');
// 			expect(result).toEqual({
// 				basename: 'folder',
// 				pathParts: [],
// 				type: 'folder',
