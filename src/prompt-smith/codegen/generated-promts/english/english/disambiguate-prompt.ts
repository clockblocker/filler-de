...
Rules:
- Compare the contextual meaning against each sense's emojiDescription emojis and linguistic features (unitKind, pos, phrasemeKind)
...
<example-3>
<input>
{"context":"To be honest, I did not expect that.","lemma":"to be honest","senses":[{"emojiDescription":["🗣️"],"index":1,"phrasemeKind":"DiscourseFormula","unitKind":"Phrasem"},{"emojiDescription":["🤝"],"index":2,"phrasemeKind":"Collocation","unitKind":"Phrasem"}]}
</input>
<output>
{"matchedIndex":1}
</output>
